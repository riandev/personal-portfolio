...
const Resume = () => {
  ...
  return (
    <div className="container mt-4">
      <div style={{ borderRadius: "10px" }} className="background">
        <div className="row mt-5 mb-5 pl-3">
          <div className="col-md-6">
            <h3 className="text-white">Work Participation</h3>
            ...
            <Card.Link
              ...
              target="_blank"
              href="https://drive.google.com/u/0/uc?id=1qEOa5Jjo5zOZ61kakCnrsIicm3jKXQ85&export=download"
            >
              Download Resume
            </Card.Link>
          </div>
